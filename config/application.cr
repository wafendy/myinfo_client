...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Myinfo Client web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 5DKrSrKPUsp6C8BTMK77HUSx0Ifo-58cmPcI456sxBU
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("myinfo_client.log", "w"))
  #
  #
end
